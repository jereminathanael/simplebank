...
func (distributor *RedisTaskDistributor) DistributeTaskSendVerifiyEmail(
	ctx context.Context,
...
func (processor *RedisTaskProcessor) ProcessorTaskSendVerifyEmail(ctx context.Context, task *asynq.Task) error {
	...
	if err := json.Unmarshal(task.Payload(), &payload); err != nil {
		return fmt.Errorf("failed to umarshal payload: %w", asynq.SkipRetry)
	}
	...
	Pleas <a href="%s">click here</a> to verify your email address.<br/>
